...
#                     # try:
#                     #     # print(list1[j])
#                     #     if isinstance(list1[int(j)], (list, tuple)):
#                     #         for num in list1[int(j)]:
#                     #             div1(int(num), int(d))
#                         if isinstance(list1[int(j)], (int, float)):
...
#
# # l1 = ('fdsfs', 4, [43, 5])
# # if isinstance(l1, (list, int)):
# #     print('it works ?')

def inputel(n):
    """ A simple function to input the elements to be checked for divisibility """
